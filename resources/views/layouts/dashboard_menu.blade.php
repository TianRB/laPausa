  <ul class="nav flex-column mb-2" id="dashboard_menu">
    <li class="nav-item bg-3 py-2">
        <a class="nav-link text-white brand-name m-0" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="38.333" height="35.921" viewBox="0 0 38.333 35.921">
    ...
    <li class="nav-item"><a class="nav-link" href="{{ route('tipos_cultivo.index') }}">Tipos Cultivo</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('familias.index') }}">Familias</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('tipos_cosecha.index') }}">Tipos de Cosecha</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('tipos_siembra.index') }}">Tipos de Siembra</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('proveedores.index') }}">Proveedores</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('enfermedades_y_plagas.index') }}">Enfermedades y plagas</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('areas.index') }}">Areas</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('biocamas.index') }}">Biocamas</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('grupos.index') }}">Grupos</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('cultivos.index') }}">Cultivos</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('catalogo_animales.index') }}">Catalogo de Animales</a></li>
